"""
Django settings for ouahdina project.
...
SECRET_KEY = 'django-insecure-241v^quae-^__iq-@l1&0ou*+x5_5)=x4)d2&s1f^v-o!(gn=$'
...
WSGI_APPLICATION = 'ouahdina.wsgi.application'
